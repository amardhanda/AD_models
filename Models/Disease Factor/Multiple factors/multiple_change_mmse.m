%mmse = load('/Users/amardhanda/Documents/MATLAB/AD/Variable decay/MMSE/normal_mmse');
mmse = load('/Users/amardhanda/Documents/MATLAB/AD/Variable decay/MMSE/disease_mmse');
    ...
    for k = 1: length(disease_factors) - 1
        for l = base : length(disease_factors)
            ...
            for i = 1:l1
                ...
                dif_scr_dis = mean(bootstrp(lngth,@mean,disease(3,42,:)));
